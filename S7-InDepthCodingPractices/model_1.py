...
"""
TARGET: 
Get a basic skelatal of model with less than 8000 parameters
...
ANALYSIS:
1. There is no overfitting rather slight underfitting, thats fine dropout is doing its work , because we are adding dropout at each layer the model is able to capture the training accuracy
